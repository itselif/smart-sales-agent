...
describe("ListRegisteredStores", () => {
  ...
  beforeEach(() => {
    ...
    ControllerClass = proxyquire(
      "../../../../src/manager-layer/main/Store/list-registeredstores",
      {
        "./StoreManager": class {
