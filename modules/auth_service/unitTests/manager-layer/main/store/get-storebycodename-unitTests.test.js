...
describe("GetStoreByCodename", () => {
  ...
  beforeEach(() => {
    ...
    ControllerClass = proxyquire(
      "../../../../src/manager-layer/main/Store/get-storebycodename",
      {
        "./StoreManager": class {
