...
//these tests will work when DbCreateUserCommand is exported from main code
describe("DbCreateUserCommand", () => {
  let DbCreateUserCommand, dbCreateUser;
  ...
  beforeEach(() => {
    ...
    ({ DbCreateUserCommand, dbCreateUser } = proxyquire(
      "../../../../src/db-layer/main/user/dbCreateUser",
      {
  ...
  describe("constructor", () => {
    it("should assign initial properties", () => {
      const cmd = new DbCreateUserCommand({});
      expect(cmd.commandName).to.equal("dbCreateUser");
  ...
  /* describe("runDbCommand", () => {
    ...
    it("should update existing user if found by unique index", async () => {
      ...
      const cmd = new DbCreateUserCommand(input);
  ...
  describe("dbCreateUser", () => {
    it("should execute successfully and return dbData", async () => {
      ...
      const result = await dbCreateUser(input);
