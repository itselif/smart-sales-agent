...
//these tests will work when DbRegisterStoreownerCommand is exported from main code
describe("DbRegisterStoreownerCommand", () => {
  let DbRegisterStoreownerCommand, dbRegisterStoreowner;
  ...
  beforeEach(() => {
    ...
    ({ DbRegisterStoreownerCommand, dbRegisterStoreowner } = proxyquire(
      "../../../../src/db-layer/main/user/dbRegisterStoreowner",
      {
  ...
  describe("constructor", () => {
    it("should assign initial properties", () => {
      const cmd = new DbRegisterStoreownerCommand({});
      expect(cmd.commandName).to.equal("dbRegisterStoreowner");
  ...
  /* describe("runDbCommand", () => {
    ...
    it("should update existing user if found by unique index", async () => {
      ...
      const cmd = new DbRegisterStoreownerCommand(input);
  ...
  describe("dbRegisterStoreowner", () => {
    it("should execute successfully and return dbData", async () => {
      ...
      const result = await dbRegisterStoreowner(input);
