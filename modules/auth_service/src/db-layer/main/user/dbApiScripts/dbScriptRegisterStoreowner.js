...
// This script is called from the RegisterStoreOwnerManager
...
const dbScriptRegisterStoreowner = async (apiManager) => {
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptRegisterStoreowner",
      {
...
module.exports = dbScriptRegisterStoreowner;
