...
class DbRegisterStoreownerCommand extends DBCreateSequelizeCommand {
  constructor(input) {
    super(input);
    this.commandName = "dbRegisterStoreowner";
...
const dbRegisterStoreowner = async (input) => {
  const dbCreateCommand = new DbRegisterStoreownerCommand(input);
  return await dbCreateCommand.execute();
};

module.exports = dbRegisterStoreowner;
