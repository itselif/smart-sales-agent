...
class DbListRegisteredstoresCommand extends DBGetListSequelizeCommand {
  constructor(input) {
    super(input);
    this.commandName = "dbListRegisteredstores";
...
const dbListRegisteredstores = (input) => {
  const dbGetListCommand = new DbListRegisteredstoresCommand(input);
  return dbGetListCommand.execute();
};

module.exports = dbListRegisteredstores;
