...
class GetStoreAssignmentMcpController extends StoreManagementMcpController {
  constructor(params) {
    super("getStoreAssignment", "getstoreassignment", params);
    this.dataName = "storeAssignment";
    this.crudType = "get";
  }

  createApiManager() {
    return new GetStoreAssignmentManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: GetStoreAssignmentMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const getStoreAssignmentMcpController =
        new GetStoreAssignmentMcpController(mcpParams);
      try {
        const result = await getStoreAssignmentMcpController.processRequest();
        //return GetStoreAssignmentMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
