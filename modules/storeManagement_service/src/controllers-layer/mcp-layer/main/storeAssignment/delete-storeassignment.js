...
class DeleteStoreAssignmentMcpController extends StoreManagementMcpController {
  constructor(params) {
    super("deleteStoreAssignment", "deletestoreassignment", params);
    this.dataName = "storeAssignment";
    this.crudType = "delete";
  }

  createApiManager() {
    return new DeleteStoreAssignmentManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: DeleteStoreAssignmentMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const deleteStoreAssignmentMcpController =
        new DeleteStoreAssignmentMcpController(mcpParams);
      try {
        const result =
          await deleteStoreAssignmentMcpController.processRequest();
        //return DeleteStoreAssignmentMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
