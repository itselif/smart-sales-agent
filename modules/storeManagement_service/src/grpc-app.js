...
const storeManagementPackage = grpcObject.storeManagement;

const server = new grpc.Server();

function helloMessage(call, callback) {
  callback(null, { hello: "hello, this is salesai-storemanagement-service" });
}

const {} = require("./controllers-layer/grpc-layer");

server.addService(storeManagementPackage.storeManagementService.service, {
  helloMessage,
  ...sessionRouter,
});
