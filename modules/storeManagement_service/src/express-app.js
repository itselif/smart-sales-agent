...
const {
  ...
  storeRouter,
  storeAssignmentRouter,
} = require("restLayer");

app.use("", storeRouter);
app.use("", storeAssignmentRouter);
...
app.get("/getPostmanCollection", (req, res) => {
  const filePath = path.join(
    __dirname,
    "salesai-storeManagement-postman-collection.json",
  );
  console.log("Downloading Postman Collection from:", filePath);
  res.setHeader("Content-Type", "application/json");
  res.setHeader(
    "Content-Disposition",
    'attachment; filename="salesai-storeManagement-postman-collection.json"',
  );
