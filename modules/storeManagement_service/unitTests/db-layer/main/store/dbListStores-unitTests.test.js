...
//these tests will work when DbListStoresCommand is exported from main code

describe("DbListStoresCommand", () => {
  let DbListStoresCommand, dbListStores;
  ...
  beforeEach(() => {
    ...
    ({ DbListStoresCommand, dbListStores } = proxyquire(
      "../../../../src/db-layer/main/store/dbListStores",
      {
  ...
  describe("constructor", () => {
    it("should initialize command metadata and reset pagination if needed", () => {
      ...
      const cmd = new DbListStoresCommand(input);

      expect(cmd.commandName).to.equal("dbListStores");
  ...
  describe("getCqrsJoins", () => {
    it("should call Store.getCqrsJoins if defined", async () => {
      const cmd = new DbListStoresCommand({});
  ...
  describe("buildIncludes", () => {
    ...
    it("should return [] includes even if getJoins is absent", () => {
      const cmd = new DbListStoresCommand({}); // input.getJoins is undefined
  ...
  describe("executeQuery", () => {
    it("should handle empty selectList and skip attributes", async () => {
      const cmd = new DbListStoresCommand({ getJoins: false });
