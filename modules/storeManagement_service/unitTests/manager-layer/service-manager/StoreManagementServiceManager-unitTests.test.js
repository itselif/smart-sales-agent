...
describe("StoreManagementServiceManager", () => {
  let StoreManagementServiceManager;
  let ApiManagerMock;
  ...
  beforeEach(() => {
    ...
    StoreManagementServiceManager = proxyquire(
      "../../../src/manager-layer/service-manager/StoreManagementServiceManager",
      {
  ...
  describe("readTenantId()", () => {
    it("should read _storeId from query if present", () => {
      ...
      const manager = new StoreManagementServiceManager(req, {});
  ...
  describe("userHasRole()", () => {
    ...
    it("should return false if no auth", () => {
      const manager = new StoreManagementServiceManager({}, {});
