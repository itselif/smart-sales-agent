...
class DeleteReportPolicyMcpController extends ReportingMcpController {
  constructor(params) {
    super("deleteReportPolicy", "deletereportpolicy", params);
    this.dataName = "reportPolicy";
    this.crudType = "delete";
  }

  createApiManager() {
    return new DeleteReportPolicyManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: DeleteReportPolicyMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const deleteReportPolicyMcpController =
        new DeleteReportPolicyMcpController(mcpParams);
      try {
        const result = await deleteReportPolicyMcpController.processRequest();
        //return DeleteReportPolicyMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
