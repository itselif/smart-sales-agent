...
class ListReportPoliciesMcpController extends ReportingMcpController {
  constructor(params) {
    super("listReportPolicies", "listreportpolicies", params);
    this.dataName = "reportPolicies";
    this.crudType = "getList";
  }

  createApiManager() {
    return new ListReportPoliciesManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: ListReportPoliciesMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const listReportPoliciesMcpController =
        new ListReportPoliciesMcpController(mcpParams);
      try {
        const result = await listReportPoliciesMcpController.processRequest();
        //return ListReportPoliciesMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
