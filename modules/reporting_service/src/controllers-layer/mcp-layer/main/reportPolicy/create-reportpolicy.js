...
class CreateReportPolicyMcpController extends ReportingMcpController {
  constructor(params) {
    super("createReportPolicy", "createreportpolicy", params);
    this.dataName = "reportPolicy";
    this.crudType = "create";
  }

  createApiManager() {
    return new CreateReportPolicyManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: CreateReportPolicyMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const createReportPolicyMcpController =
        new CreateReportPolicyMcpController(mcpParams);
      try {
        const result = await createReportPolicyMcpController.processRequest();
        //return CreateReportPolicyMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
