...
class GetReportRequestMcpController extends ReportingMcpController {
  constructor(params) {
    super("getReportRequest", "getreportrequest", params);
    this.dataName = "reportRequest";
    this.crudType = "get";
  }

  createApiManager() {
    return new GetReportRequestManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: GetReportRequestMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const getReportRequestMcpController = new GetReportRequestMcpController(
        mcpParams,
      );
      try {
        const result = await getReportRequestMcpController.processRequest();
        //return GetReportRequestMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
