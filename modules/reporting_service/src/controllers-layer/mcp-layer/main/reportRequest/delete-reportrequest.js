...
class DeleteReportRequestMcpController extends ReportingMcpController {
  constructor(params) {
    super("deleteReportRequest", "deletereportrequest", params);
    this.dataName = "reportRequest";
    this.crudType = "delete";
  }

  createApiManager() {
    return new DeleteReportRequestManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: DeleteReportRequestMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const deleteReportRequestMcpController =
        new DeleteReportRequestMcpController(mcpParams);
      try {
        const result = await deleteReportRequestMcpController.processRequest();
        //return DeleteReportRequestMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
