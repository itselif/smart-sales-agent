...
describe("ReportingServiceManager", () => {
  let ReportingServiceManager;
  let ApiManagerMock;
  ...
  beforeEach(() => {
    ...
    ReportingServiceManager = proxyquire(
      "../../../src/manager-layer/service-manager/ReportingServiceManager",
      {
  ...
  describe("readTenantId()", () => {
    it("should read _storeId from query if present", () => {
      ...
      const manager = new ReportingServiceManager(req, {});
  ...
  describe("userHasRole()", () => {
    ...
    it("should return false if no auth", () => {
      const manager = new ReportingServiceManager({}, {});
