...
describe("ReportFileManager", () => {
  ...
  beforeEach(() => {
    ...
    ManagerClass = proxyquire(
      "../../../../src/manager-layer/main/ReportFile/ReportFileManager",
      {
  ...
  describe("constructor", () => {
    it("should initialize properties correctly", () => {
      ...
      expect(instance).to.have.property("objectName", "reportFile");
      expect(instance).to.have.property("modelName", "ReportFile");
