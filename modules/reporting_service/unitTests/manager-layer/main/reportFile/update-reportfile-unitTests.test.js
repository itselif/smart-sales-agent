...
describe("UpdateReportFile", () => {
  ...
  beforeEach(() => {
    ...
    ControllerClass = proxyquire(
      "../../../../src/manager-layer/main/ReportFile/update-reportfile",
      {
        "./ReportFileManager": class {
