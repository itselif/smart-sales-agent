...
describe("ReportPolicyManager", () => {
  ...
  beforeEach(() => {
    ...
    ManagerClass = proxyquire(
      "../../../../src/manager-layer/main/ReportPolicy/ReportPolicyManager",
      {
  ...
  describe("constructor", () => {
    it("should initialize properties correctly", () => {
      ...
      expect(instance).to.have.property("objectName", "reportPolicy");
      expect(instance).to.have.property("modelName", "ReportPolicy");
