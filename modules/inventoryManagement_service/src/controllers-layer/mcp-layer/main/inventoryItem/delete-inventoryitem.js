...
class DeleteInventoryItemMcpController extends InventoryManagementMcpController {
  constructor(params) {
    super("deleteInventoryItem", "deleteinventoryitem", params);
    this.dataName = "inventoryItem";
    this.crudType = "delete";
  }

  createApiManager() {
    return new DeleteInventoryItemManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: DeleteInventoryItemMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const deleteInventoryItemMcpController =
        new DeleteInventoryItemMcpController(mcpParams);
      try {
        const result = await deleteInventoryItemMcpController.processRequest();
        //return DeleteInventoryItemMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
