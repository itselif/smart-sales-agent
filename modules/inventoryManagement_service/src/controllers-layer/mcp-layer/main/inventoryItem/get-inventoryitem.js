...
class GetInventoryItemMcpController extends InventoryManagementMcpController {
  constructor(params) {
    super("getInventoryItem", "getinventoryitem", params);
    this.dataName = "inventoryItem";
    this.crudType = "get";
  }

  createApiManager() {
    return new GetInventoryItemManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: GetInventoryItemMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const getInventoryItemMcpController = new GetInventoryItemMcpController(
        mcpParams,
      );
      try {
        const result = await getInventoryItemMcpController.processRequest();
        //return GetInventoryItemMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
