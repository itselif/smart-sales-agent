...
class GetInventoryMovementMcpController extends InventoryManagementMcpController {
  constructor(params) {
    super("getInventoryMovement", "getinventorymovement", params);
    this.dataName = "inventoryMovement";
    this.crudType = "get";
  }

  createApiManager() {
    return new GetInventoryMovementManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: GetInventoryMovementMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const getInventoryMovementMcpController =
        new GetInventoryMovementMcpController(mcpParams);
      try {
        const result = await getInventoryMovementMcpController.processRequest();
        //return GetInventoryMovementMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
