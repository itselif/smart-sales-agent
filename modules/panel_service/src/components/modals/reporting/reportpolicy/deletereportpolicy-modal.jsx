...
export default function ReportingDeleteReportPolicyModal({
  openDialog,
  selectedId,
}) {
  ...
  return (
    <Dialog open={openDialog.value} maxWidth="md">
      <DialogTitle>Delete ReportPolicy</DialogTitle>
      <DialogContent>
        do you want to delete the reportPolicy with id: {selectedId}
      </DialogContent>
