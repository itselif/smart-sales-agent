...
export default function SalesManagementCreateSaleTransactionHistoryModal({
  openDialog,
}) {
  ...
  return (
    <Dialog open={openDialog.value} maxWidth="md">
      <DialogTitle>Create SaleTransactionHistory</DialogTitle>
        ...
        <DialogContent>
          ...
          {error && (
            <DialogContentText color="error">
              {error.message
                ? error.message
                : "An error occurred while creating the saleTransactionHistory."}
            </DialogContentText>
          )}
        </DialogContent>
