...
export default function InventoryManagementDeleteLowStockAlertModal({
  openDialog,
  selectedId,
}) {
  ...
  return (
    <Dialog open={openDialog.value} maxWidth="md">
      <DialogTitle>Delete LowStockAlert</DialogTitle>
      <DialogContent>
        do you want to delete the lowStockAlert with id: {selectedId}
      </DialogContent>
