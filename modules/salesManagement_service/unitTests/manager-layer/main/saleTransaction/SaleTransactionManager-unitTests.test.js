...
describe("SaleTransactionManager", () => {
  let ManagerClass;
  let manager;
  let req;
  ...
  beforeEach(() => {
    ...
    ManagerClass = proxyquire(
      "../../../../src/manager-layer/main/SaleTransaction/SaleTransactionManager",
      {
  ...
  describe("constructor", () => {
    it("should initialize properties correctly", () => {
      ...
      expect(instance).to.have.property("objectName", "saleTransaction");
      expect(instance).to.have.property("modelName", "SaleTransaction");
