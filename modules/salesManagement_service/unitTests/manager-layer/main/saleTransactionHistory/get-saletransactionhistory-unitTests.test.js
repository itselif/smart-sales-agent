...
describe("GetSaleTransactionHistory", () => {
  let ControllerClass;
  let req;
  ...
  beforeEach(() => {
    ...
    ControllerClass = proxyquire(
      "../../../../src/manager-layer/main/SaleTransactionHistory/get-saletransactionhistory",
      {
  ...
  it("should initialize controller with correct base properties", () => {
    ...
    expect(instance.options.name).to.equal("getSaleTransactionHistory");
