...
describe("SalesManagementServiceManager", () => {
  let SalesManagementServiceManager;
  let ApiManagerMock;
  ...
  beforeEach(() => {
    ...
    SalesManagementServiceManager = proxyquire(
      "../../../src/manager-layer/service-manager/SalesManagementServiceManager",
      {
  ...
  describe("readTenantId()", () => {
    it("should read _storeId from query if present", () => {
      ...
      const manager = new SalesManagementServiceManager(req, {});
  ...
  describe("userHasRole()", () => {
    ...
    it("should return false if no auth", () => {
      const manager = new SalesManagementServiceManager({}, {});
