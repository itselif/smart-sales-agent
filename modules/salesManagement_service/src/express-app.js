...
const {
  ...
  saleTransactionRouter,
  saleTransactionHistoryRouter,
} = require("restLayer");

app.use("", saleTransactionRouter);
app.use("", saleTransactionHistoryRouter);
...
app.get("/getPostmanCollection", (req, res) => {
  const filePath = path.join(
    __dirname,
    "salesai-salesManagement-postman-collection.json",
  );
  console.log("Downloading Postman Collection from:", filePath);
  res.setHeader("Content-Type", "application/json");
  res.setHeader(
    "Content-Disposition",
    'attachment; filename="salesai-salesManagement-postman-collection.json"',
  );
