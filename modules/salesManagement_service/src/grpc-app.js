...
const salesManagementPackage = grpcObject.salesManagement;

const server = new grpc.Server();

function helloMessage(call, callback) {
  callback(null, { hello: "hello, this is salesai-salesmanagement-service" });
}

const {} = require("./controllers-layer/grpc-layer");

server.addService(salesManagementPackage.salesManagementService.service, {
  helloMessage,
  ...sessionRouter,
});
