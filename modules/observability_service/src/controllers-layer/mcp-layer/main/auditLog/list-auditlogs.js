...
class ListAuditLogsMcpController extends ObservabilityMcpController {
  constructor(params) {
...
module.exports = (headers) => {
  return {
    name: "listAuditLogs",
    description:
      "Paginated/filterable query of audit logs by user, store, time, entity, and action for sellers, managers, or admins.",
