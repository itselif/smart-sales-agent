...
class UpdateAnomalyEventMcpController extends ObservabilityMcpController {
  constructor(params) {
    super("updateAnomalyEvent", "updateanomalyevent", params);
    this.dataName = "anomalyEvent";
    this.crudType = "update";
  }

  createApiManager() {
    return new UpdateAnomalyEventManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    description:
      "Update details/review/status for anomaly investigation/closure.",
    parameters: UpdateAnomalyEventMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const updateAnomalyEventMcpController =
        new UpdateAnomalyEventMcpController(mcpParams);
      try {
        const result = await updateAnomalyEventMcpController.processRequest();
        //return UpdateAnomalyEventMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
