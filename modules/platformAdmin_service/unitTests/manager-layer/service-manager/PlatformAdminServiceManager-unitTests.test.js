...
describe("PlatformAdminServiceManager", () => {
  let PlatformAdminServiceManager;
  let ApiManagerMock;
  ...
  beforeEach(() => {
    ...
    PlatformAdminServiceManager = proxyquire(
      "../../../src/manager-layer/service-manager/PlatformAdminServiceManager",
      {
  ...
  describe("readTenantId()", () => {
    it("should read _storeId from query if present", () => {
      ...
      const manager = new PlatformAdminServiceManager(req, {});
  ...
  describe("userHasRole()", () => {
    ...
    it("should return false if no auth", () => {
      const manager = new PlatformAdminServiceManager({}, {});
