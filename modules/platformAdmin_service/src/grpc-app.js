...
const platformAdminPackage = grpcObject.platformAdmin;

const server = new grpc.Server();

function helloMessage(call, callback) {
  callback(null, { hello: "hello, this is salesai-platformadmin-service" });
}

const {} = require("./controllers-layer/grpc-layer");

server.addService(platformAdminPackage.platformAdminService.service, {
  helloMessage,
  ...sessionRouter,
});
