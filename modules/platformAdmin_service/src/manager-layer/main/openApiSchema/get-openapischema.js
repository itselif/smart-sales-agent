...
const { dbGetOpenapischema } = require("dbLayer");

class GetOpenApiSchemaManager extends OpenApiSchemaManager {
  ...
  async doBusiness() {
    // Call DbFunction
    // make an awaited call to the dbGetOpenapischema function to get the openapischema and return the result to the controller
    const openapischema = await dbGetOpenapischema(this);
...
module.exports = GetOpenApiSchemaManager;
