...
const { dbUpdateOpenapischema } = require("dbLayer");

class UpdateOpenApiSchemaManager extends OpenApiSchemaManager {
  ...
  async doBusiness() {
    // Call DbFunction
    // make an awaited call to the dbUpdateOpenapischema function to update the openapischema and return the result to the controller
    const openapischema = await dbUpdateOpenapischema(this);
...
module.exports = UpdateOpenApiSchemaManager;
